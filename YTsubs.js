...
var channelId = 'UC78KNqhC4SZ0oHsnTF9erAA'
var apiKey = 'AIzaSyCX3i8Sk6XKyuNnILPi9D6PxwXHxr9wP9M'
...
function subs(){
    ...
    var json = ('https://www.googleapis.com/youtube/v3/channels?part=statistics&id=UC78KNqhC4SZ0oHsnTF9erAA&key=AIzaSyCX3i8Sk6XKyuNnILPi9D6PxwXHxr9wP9M');
...
function subsT(){
    ...
    var json = ('https://api.twitch.tv/kraken/channels/ejnshtein/follows?client_id=s28lwjbid3b8ihhw22r7s1q2o0bjxz');
    xmlhttp.open("GET", json, true);
    xmlhttp.send();
    var UpdateTime = setTimeout(subs, 1000);
};